...
**Mod Forum:** <a href="http://www.shsforums.net/forum/574-yoshimo-friendship/">Yoshimo Friendship</a><br /><br />
...
The Yoshimo Friendship mod should be compatible with all WeiDU mods, however, we cannot test every single one. It is only compatible with BGII: ToB. If you do encounter an error, please let us know by posting the message at our forums.

>Although it is not required for the Yoshimo Friendship to function properly, it is always a good idea to install the latest version of the <a href="http://www.gibberlings3.net/bg2fixpack/">BG2 Fixpack</a>.
...
<em>If you've previously installed the mod, remove it before extracting the new version. To do this, run **`setup-yoshimo.exe`**, un-install the previously installed main component and delete the :file_folder: yoshimo folder.</em>
...
- Component: added *DESIGNATED* number and "*yoshimo_friendship*" LABEL.
